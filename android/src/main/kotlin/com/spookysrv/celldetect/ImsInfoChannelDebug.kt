 ...
 */
object ImsInfoChannelDebug {
    private const val CHANNEL_NAME = "com.spookysrv.celldetect/telephonyDebug"
        ...
        channel?.setMethodCallHandler { call, result ->
            when (call.method) {
                "getVoiceNetworkType" -> {
                    ...
                    var dataTypeReadable = when (dataType) {
                    ...
                    result.success("Voice type: $voiceType, Data type: $dataTypeReadable")
                }
                "isImsRegistered" -> {
                    ...
                    fun parseAndReply(serviceState: ServiceState) {
                        ...
                        try {
                            result.success("isImsRegistered: $isRegistered; full ServiceState: $ssString")
                        } catch (e: Exception) {
